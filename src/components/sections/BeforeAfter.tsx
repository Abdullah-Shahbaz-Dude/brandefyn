              ...
              {CASE_STUDIES.slice(0, 1).map((study) => {
                ...
                return (
                  <>
                    {/* Before label */}
                    <p
                      className="text-white text-center text-lg sm:text-xl md:text-2xl leading-tight min-w-0 order-1 sm:order-none"
                      style={{
                        fontFamily:
                    ...
                    {/* After label */}
                    <p
                      className="text-white text-center text-lg sm:text-xl md:text-2xl leading-tight min-w-0 order-3 sm:order-none"
                      style={{
                        fontFamily:
                          '"Inter Tight", Inter, system-ui, sans-serif',
                        fontWeight: 400,
