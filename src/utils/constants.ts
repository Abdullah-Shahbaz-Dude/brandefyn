...
export const CASE_STUDIES_GRID = [
  ...
  },
  {
    ...
    fullDetails: {
      ...
      overview: 'This brand operates in Beauty & Personal Care and partnered up to grow and scale their presence on Amazon. Their main goal was to scale sales, reduce advertising inefficiency, and improve profit margins.',
      challenges: [
      ...
      longTermGrowth: {
        ...
        paragraph: 'Over 1.5 years, this brand surpassed $678K in total Amazon sales',
      },
      summary: [
