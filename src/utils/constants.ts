export const NAV_ITEMS = [
  ...
  { label: "Book a Call", path: "#free-audit" },
];
...
export const CASE_STUDIES = [
  {
    ...
    quote:
      "We started working with a client in the mid September 2024 who wanted to close his business. He hired us for the sake of selling inventory profitably so that he can pay his lendings/depts and shut down on Amazon.",
    author: "Ben",
...
export const CASE_STUDIES_GRID = [
  {
    ...
    description:
      "Strong financial performance with 39.3% margin—over $1M sales and healthy advertising efficiency in a competitive category.",
    category: "Health & Wellness",
    image: "/src/assets/images/case-studies/liquidation-before.jpg",
    fullDetails: {
      brandName: "LOOREADY USA",
      quote:
        "This supplement brand has achieved strong financial performance with impressive profitability and healthy advertising efficiency.",
      author: "Client",
      ...
      performanceSummary: {
        ...
        profitMargin: "39.3%",
        paragraph:
          "With a net margin of 39.3%, this brand stands out for its high profitability in a competitive category. Despite investing over $112K in advertising, the brand maintained strong cost control and scaled efficiently. The advertising strategy has proven to be both impactful and cost-effective, contributing to growth while preserving margins.",
        paragraph2:
          "This case reflects the value of optimized ad spend, high-converting listings, and a strong product-market fit in achieving sustainable, high-margin growth on Amazon.",
      },
      imageSlots: 1,
    },
  },
  {
    ...
    description:
      "Doubled PPC sales and boosted CTR in just a few months; reduced ACoS and improved BSR with constant pricing for LOOREADY USA.",
    category: "Health & Wellness",
    image: "/src/assets/images/case-studies/flower-power-before.jpg",
    fullDetails: {
      brandName: "LOOREADY USA",
      quote:
        "When this brand partnered with us, they faced flat PPC performance, high ACoS, and a lack of conversions. Within a few months we turned things around.",
      author: "Client",
      role: "LOOREADY USA",
      ppcStats: {
        headline:
          "From Modest PPC Results to Impressive Growth: Doubled PPC Sales and Boosted CTR in Just a Few Months!",
        intro:
          "When this brand partnered with us, they were facing typical challenges: flat PPC performance, high ACoS, and a lack of conversions. But within just a few months, we turned things around with remarkable results:",
        stats: [
          {
            label: "PPC Sales",
            value: "Increased from $3,793.10 to $7,099.01",
          },
          {
            label: "PPC Orders",
            value: "Jumped from 172 to 354 (over 50% growth!)",
          },
          { label: "ACoS", value: "Reduced from 40% to a lean 35.97%" },
          { label: "CTR", value: "Improved from 0.87% to 1.32%" },
          {
            label: "Total Sales",
            value: "Uplifted from $12,473.78 to $16,391.26",
          },
        ],
      },
      steps: [
      ...
      keyTakeaway:
        "By blending creative listing optimization and data-driven PPC strategies, we dramatically improved this brand's performance, doubling PPC sales and slashing ACoS. If your brand struggles with stagnant sales or inefficient ad spend, let's connect and turn things around!",
      imageSlots: 2,
    },
  },
  {
  ...
  },
  {
    ...
    description:
      "This brand operates in Beauty & Personal Care and partnered with us to grow their Amazon presence organically and via advertising. Their main goal was to scale sales, reduce advertising inefficiency, and improve profit margins. Sales grew by over 90% in 3 months.",
    category: "Home & Personal Care",
    image: "/src/assets/images/case-studies/flower-power-after.jpg",
    fullDetails: {
      quote:
        "Our data-driven Amazon ads strategy unlocked scalable growth, improved conversion rates, and delivered long-term profitability for a competitive category.",
      author: "Client",
      role: "Home & Personal Care Brand",
      overview:
        "This brand operates in Beauty & Personal Care and partnered up to grow and scale their presence on Amazon. Their main goal was to scale sales, reduce advertising inefficiency, and improve profit margins.",
      challenges: [
        "Weak profit margins due to high costs and competition",
        "Limited visibility and inconsistent monthly revenue",
        "High advertising spend with lower return on ad spend",
      ],
      ourStrategy: [
        "Step A: We started reducing budgets on campaigns with lower ROAS and High ACOS. We just gave more budgets to the campaigns with better performance in terms of Positioning/Placements and Performance.",
        "Step B: We started ads on our star products mostly at first. It was all about budget management on this brand to bring us great results because we sort it out which is action to be done at the start.",
        "Step C: The steps above acted really positively, increasing our sales just in the next month and 2.5x PROFITS.",
      ],
      performanceResults: [
        "Sales grew by almost 91% from April to June",
        "Net profit increased 2.5x while ad spend decreased",
        "Advertising efficiency improved — ACoS dropped significantly",
      ],
      longTermGrowth: {
        period: "Jan 2024 – July 9, 2025",
        paragraph:
          "Over 1.5 years, this brand surpassed $678K in total Amazon sales",
      },
      summary: [
        "Sales grew by almost 91% in 3 months",
      ...
      caseStudy2: {
        title:
          "Case Study 2: Year-over-Year Brand Growth with Strategic PPC Execution",
        intro:
          "This case study outlines the significant year-over-year growth on Amazon for a kitchen brand. As of the current date in 2025, the brand has already surpassed its full-year 2024 performance, reaching 3,688 units sold and generating $131,331.59 in revenue — compared to 2,193 units and $68,776.65 in 2024. This reflects a 100% increase in YoY sales volume and 190% for some months.",
        challenges: [
          "Since this was a bulky item",
          "Bringing sales required a lot of trust.",
          "The reviews were really a FACTOR.",
          "The conversion was so low [ Can say it a Pro at some level :) ]",
        ],
        howWeFixedIt: [
          "The PPC ad spend was high to bring in sales with high CPCs - Selling bidding higher for the converting placements so we optimised ads for ROS only.",
          "Utilised the rest / saved ad spend in making the listing conversion best among our competitors.",
          "Changed the demographics from SP to SB most to give more space and relaxed shopping experience to customers.",
          "Highly focused on NTB orders rather than Remarketing/Retargeting.",
        ],
        baseLevelPpc: [
          "Deployed a full-funnel PPC structure, including Sponsored Products, Sponsored Brands, and Sponsored Display.",
          "Conducted weekly optimization of search terms to eliminate non-performers and scale top-converting keywords.",
          "Continuously monitored ACoS and ROAS, maintaining profitability while increasing visibility.",
        ],
        conclusion:
          "With over half the year remaining, the brand's 2025 performance has already exceeded the total achievements of 2024. The data clearly shows that continuous PPC management, combined with listing optimization and sound operational planning, can significantly accelerate brand performance on Amazon. This case illustrates the measurable impact of a strategic, hands-on approach to marketplace growth.",
      },
      imageSlots: 0,
    },
  },
...
export const CLIENT_TESTIMONIALS = [
  {
    ...
    quote:
      "The big advantage from working with the team is they're constantly available. We meet at least every other week, but they're also available on Slack, and anytime we run into issues, we're able to jump on them and resolve them really quickly.",
    name: "Jackson",
  ...
  },
  {
    ...
    quote:
      "Working with Brandefyn has transformed our Amazon business. Their strategic approach to PPC management increased our sales by 300% in just 6 months. The team is professional, responsive, and truly understands the Amazon ecosystem.",
    name: "Sarah Johnson",
  ...
  },
  {
    ...
    quote:
      "The best decision we made was partnering with Brandefyn. They took our struggling brand and turned it into a top performer. Their expertise in brand management and optimization is unmatched.",
    name: "Michael Chen",
